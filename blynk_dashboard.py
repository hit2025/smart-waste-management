...
def qrcode():
    ...
    <img src="https://api.qrserver.com/v1/create-qr-code/?data=http://http://127.0.0.1:8001/complaint_form&size=200x200"/>
    </body></html>
    """
...
if __name__ == "__main__":
    import uvicorn
    print("Open http://http://127.0.0.1:8001 for Real-Time Blynk Dashboard with Alerts")
    uvicorn.run(app, host="http://127.0.0.1", port=8001)
